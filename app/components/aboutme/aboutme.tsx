...
interface AccordionItemProps {
  ...
  const AboutMe: React.FC = () => {
    ...
    return (
      <div id='#aboutme' className="bg-gray-100 mx-auto py-12">
        <div className=" py-12 font-roboto" id='#about'>
          <h2 className="text-4xl mx-auto text-center mb-8 font-semibold font-lato">Let Me Introduce Myself</h2>
          <p className="text-base text-gray-700 w-5/6 sm:w-3/5 mx-auto mb-8 mt-8">
          ...
          <div className="sm:w-3/5 w-full mx-auto mb-24">
