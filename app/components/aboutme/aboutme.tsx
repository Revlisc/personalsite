  ...
  const AboutMe: React.FC = () => {
    ...
    return (
      <div id='#aboutme' className="mx-auto">
        <div className="bg-gray-100 pt-12" id='#about'>
          <h2 className="text-4xl mx-auto text-center mb-8 font-semibold">Let Me Introduce Myself</h2>
          <p className="text-base text-gray-700 w-5/6 sm:w-3/5 mx-auto mb-2 mt-8">
